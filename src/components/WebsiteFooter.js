function WebsiteFooter() {
  return (
    <footer class="bg-purple-900 pt-4 pb-8 xl:pt-8 mt-14">
      <div class="max-w-screen-lg px-4 mx-auto text-white xl:max-w-screen-xl sm:px-6 md:px-8 dark:text-gray-300">
            ...
            <div class="text-center">
              ...
              <ul>
                <li class="mb-4 transition-colors duration-200 hover:text-gray-800 dark:hover:text-white">
                  <a href="#">
                    <span class="text-white">Elements</span>
                  </a>
                </li>
                <li class="mb-4 transition-colors duration-200 hover:text-gray-800 dark:hover:text-white">
                  <a href="#">
                ...
                <li class="mb-4 transition-colors duration-200 hover:text-gray-800 dark:hover:text-white">
                  <a href="#">
                    <span class="text-white">Commerces</span>
                  </a>
                </li>
                <li class="mb-4 transition-colors duration-200 hover:text-gray-800 dark:hover:text-white">
                  <a href="#">
        ...
        <div class="pt-8 flex border-t border-gray-200 max-w-xs mx-auto items-center justify-between">
          <a href="#">
            <svg
              ...
              height="20"
              fill="currentColor"
              class="text-xl transition-colors duration-200 hover:text-gray-800 dark:hover:text-white text-white"
